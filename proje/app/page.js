    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="max-w-7xl mx-auto px-4 py-16">
          <h2 className="text-3xl font-bold text-red-800 mb-8 text-center">Yemek Kategorileri</h2>
        ...
        <section className="bg-red-50 py-16">
          <div className="max-w-7xl mx-auto px-4">
            <h2 className="text-3xl font-bold text-red-800 mb-8 text-center">Popüler Tarifler</h2>
            ...
            <div className="text-center mt-12">
              <a 
                href="/populer" 
                className="inline-block px-6 py-3 border-2 border-red-600 text-red-600 font-medium rounded-md hover:bg-red-600 hover:text-white transition-colors"
              >
        ...
        <section className="max-w-7xl mx-auto px-4 py-16 text-center">
          <h2 className="text-3xl font-bold text-red-800 mb-6">Mutfakta Profesyonel Ol</h2>
        ...
        <section className="bg-red-50 py-16">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold text-red-800 mb-8">Sık Sorulan Sorular</h2>
