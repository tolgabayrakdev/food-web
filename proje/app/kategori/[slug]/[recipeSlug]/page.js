          ...
          <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
            <div className="max-w-7xl mx-auto">
              <Link 
                ...
                className="text-orange-300 hover:underline mb-4 inline-block"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold mb-6 text-orange-800 border-b pb-2">Malzemeler</h2>
                <ul className="space-y-3">
                  {recipe.ingredients.map((ingredient, index) => (
                    <li key={index} className="flex items-start">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-orange-600 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold mb-6 text-orange-800 border-b pb-2">Hazırlanışı</h2>
                <ol className="space-y-6">
                  {recipe.instructions.map((step, index) => (
                    <li key={index} className="flex">
                      <div className="bg-orange-100 text-orange-800 w-8 h-8 rounded-full flex items-center justify-center mr-4 flex-shrink-0 mt-0.5">
                        {index + 1}
                      </div>
                      <div>{step}</div>
                    </li>
              ...
              <div className="mt-8 bg-orange-100 rounded-lg p-6">
                <h3 className="text-xl font-semibold mb-4 text-orange-800">Püf Noktaları</h3>
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-orange-600 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
