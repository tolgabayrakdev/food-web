      ...
      <main className="flex-grow bg-rose-50">
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          <div className="bg-white rounded-lg shadow-md p-8">
            <h2 className="text-3xl font-bold text-rose-800 mb-6">Biz Kimiz?</h2>
            ...
            <h2 className="text-3xl font-bold text-rose-800 mb-6 mt-12">Misyonumuz</h2>
            <p className="text-gray-700 mb-6">
            ...
            <h2 className="text-3xl font-bold text-rose-800 mb-6 mt-12">Vizyonumuz</h2>
            <p className="text-gray-700 mb-6">
            ...
            <h2 className="text-3xl font-bold text-rose-800 mb-6 mt-12">Ekibimiz</h2>
            <p className="text-gray-700 mb-6">
            ...
            <div className="bg-rose-100 p-6 rounded-lg mt-12">
              <h3 className="text-xl font-semibold text-rose-800 mb-4">Bize Ulaşın</h3>
