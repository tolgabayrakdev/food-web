    ...
    <div className="relative bg-cover bg-center h-[70vh]" style={{ backgroundImage: "url('/images/placeholder-food.jpg')" }}>
      ...
      <div className="relative h-full flex flex-col justify-center items-center text-center text-white p-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link 
            href="/kategoriler" 
            className="bg-rose-600 text-white px-8 py-3 rounded-md font-medium text-lg hover:bg-rose-700 transition-colors"
          >
            Tarifleri Keşfet
          </Link>
          <Link 
            href="/populer" 
            className="bg-white text-rose-800 px-8 py-3 rounded-md font-medium text-lg hover:bg-gray-100 transition-colors"
          >
            Popüler Tarifler
          </Link>
        </div>
